...
public class J_VirtualBattery {
    ...
    public J_VirtualBattery(double maxPower_kW, double batteryPowerStep_kW, double storageCapacity_kWh, double initialSOC_fr, double etaCharge_fr, double etaDischarge_fr, double timeStep_h, double length_h, boolean[] allowedOperatingTimes) {
