/**
 * J_EAConversionIronBurner
 */
public class J_EAConversionIronBurner extends zero_engine.J_EAConversion implements Serializable, I_HeatingAsset {
    ...
    public J_EAConversionIronBurner() {
    }
    ...
    public J_EAConversionIronBurner(I_AssetOwner owner, double outputElectricCapacity_kW, double outputHeatCapacity_kW, double efficiency, J_TimeParameters timeParameters, double outputTemperature_degC ) {
	    ...
	    this.energyAssetType = OL_EnergyAssetType.IRON_BURNER;
	...
	public OL_EnergyCarriers getEnergyCarrierProduced() {
		throw new RuntimeException("Can not get EnergyCarrierProduced from J_EAConversionGasCHP1, use getEnergyCarriersProduced() instead.");
	}
