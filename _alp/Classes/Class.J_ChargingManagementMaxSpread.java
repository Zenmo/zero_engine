...
public class J_ChargingManagementMaxSpread implements I_ChargingManagement {
     ...
     * Default constructor
     */
    public J_ChargingManagementMaxSpread( GridConnection gc, J_TimeParameters timeParameters) {
    	this.gc = gc;
    ...
    public void manageCharging(J_ChargePoint chargePoint, J_TimeVariables timeVariables) {
    	...
    	for (I_ChargingRequest chargeRequest : chargePoint.getCurrentActiveChargingRequests()) {
    		chargePoint.charge(chargeRequest, chargeRequest.getRemainingAverageChargingDemand_kW(t_h), timeVariables, gc);
    	}
    }
    
	public void setV2GActive(boolean activateV2G) {
		if(activateV2G) {
			throw new RuntimeException("Trying to Activate V2G for chargingManagement MaxSpread -> Not supported");
		}
	}
	...
	public String toString() {
		return "MaxSpreadCharging: Active charging type: MAX_SPREAD: " + this.activeChargingType;
