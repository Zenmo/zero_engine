/**
 * J_AggregatorEnergyManagementHPAndVehicles
 */	
...
public class J_AggregatorEnergyManagementHPAndVehicles implements I_AggregatorEnergyManagement {
	private EnergyCoop energyCoop;
	private Agent target;
	private double targetLoadLowPassed_kW;
	private double filterDiffGain_r;
    private double filterTimeScale_h = 5*24;
	
	//stored
	private double storedTargetLoadLowPassed_kW;
	
    /**
     * Default constructor
     */
	public J_AggregatorEnergyManagementHPAndVehicles( ) {

    }
	
    public J_AggregatorEnergyManagementHPAndVehicles( EnergyCoop energyCoop) {
    	this.energyCoop = energyCoop;
    	this.target = energyCoop;
    	this.filterDiffGain_r = 1/(filterTimeScale_h/energyCoop.energyModel.p_timeStep_h);
    }
    public J_AggregatorEnergyManagementHPAndVehicles( EnergyCoop energyCoop, Agent target) {
    	this.energyCoop = energyCoop;
    	this.target = target;
    	this.filterDiffGain_r = 1/(filterTimeScale_h/energyCoop.energyModel.p_timeStep_h);
    }
	...
	public void storeStatesAndReset() {
		this.storedTargetLoadLowPassed_kW = targetLoadLowPassed_kW;
		this.targetLoadLowPassed_kW = 0;
	}
	public void restoreStates() {
		this.targetLoadLowPassed_kW = storedTargetLoadLowPassed_kW;
	}
