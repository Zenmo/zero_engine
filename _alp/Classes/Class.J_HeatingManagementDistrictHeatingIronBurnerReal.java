/**
 * J_HeatingManagementDistrictHeatingIronBurnerReal
 */	
...
public class J_HeatingManagementDistrictHeatingIronBurnerReal implements I_HeatingManagement {
     ...
     * Default constructor
     */
	public J_HeatingManagementDistrictHeatingIronBurnerReal() {
		
	}
	
    public J_HeatingManagementDistrictHeatingIronBurnerReal( GridConnection gc, J_TimeParameters timeParameters, OL_GridConnectionHeatingType heatingType ) {
    ...
    public void manageHeating(J_TimeVariables timeVariables) {
    	...
    	dh.f_controlIronBurnerReal(dt_h);
