 ...
 * J_VirtualFlexAsset
 */	
public class J_VirtualFlexAsset {
    ...
    public J_VirtualFlexAsset(double maxPower_kW, int powerSteps_nr, double timeStep_h, double length_h, boolean[] allowedOperatingTimes) {
