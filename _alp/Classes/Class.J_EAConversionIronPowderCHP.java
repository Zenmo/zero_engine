/**
 * J_EAConversionIronPowderCHP
 */	
public class J_EAConversionIronPowderCHP extends zero_engine.J_EAConversion implements Serializable, I_HeatingAsset {
     ...
     * Default constructor
     */
    public J_EAConversionIronPowderCHP() {
    }

    /**
     * Constructor initializing the fields
     */
    public J_EAConversionIronPowderCHP(Agent parentAgent, double outputElectricCapacity_kW, double outputHeatCapacity_kW, double efficiency, double timestep_h, double outputTemperature_degC ) {
	    ...
	    this.energyAssetType = OL_EnergyAssetType.IRON_POWDER_CHP;
	    
    	this.energyCarriersProduced.add( OL_EnergyCarriers.ELECTRICITY );
    	this.energyCarriersProduced.add( OL_EnergyCarriers.HEAT );
    	this.energyCarrierConsumed= OL_EnergyCarriers.IRON_POWDER;
    	
        this.activeProductionEnergyCarriers.addAll(energyCarriersProduced);
    	this.activeConsumptionEnergyCarriers.add(this.energyCarrierConsumed);
    	this.assetFlowCategory = OL_AssetFlowCategories.CHPProductionElectric_kW; //Is gas CHP electricity production == iron-powder CHP electricity production?
	    registerEnergyAsset();
	}
    ...
    public void operate(double ratioOfCapacity) {
		...
		double ironPowderConsumption_kW = this.inputCapacity_kW * ratioOfCapacity;
		
		this.energyUse_kW = ironPowderConsumption_kW - heatProduction_kW - electricityProduction_kW ;
		...
		flowsMap.put(OL_EnergyCarriers.IRON_POWDER, ironPowderConsumption_kW);
