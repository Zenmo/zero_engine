/**
 * J_EAConversionIronPowderBurner
 */	
public class J_EAConversionIronPowderBurner extends zero_engine.J_EAConversion implements Serializable, I_HeatingAsset {
	
	protected double outputTemperature_degC;
    /**
     * Default constructor
     */
    public J_EAConversionIronPowderBurner() {
    }
    
    /**
     * Constructor initializing the fields
     */    
    public J_EAConversionIronPowderBurner(Agent parentAgent, double outputHeatCapacity_kW, double efficiency_r, double timestep_h, double outputTemperature_degC) {
	    ...
	    this.energyAssetType = OL_EnergyAssetType.IRON_POWDER_BURNER;
